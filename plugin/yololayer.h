...
namespace nvinfer1
{
    class API YoloLayerPlugin : public IPluginV2IOExt
    {
        public:
            ...
            Dims getOutputDimensions(int index , const Dims * inputS , int nbIputDims) const TRT_NOEXCEPT override;
            
            int initialize() TRT_NOEXCEPT override;
            virtual void terminate() TRT_NOEXCEPT override {};
            virtual size_t getWorkspaceSize(int maxBatchSize) const TRT_NOEXCEPT override { return 0;}
            virtual int enqueue(int batchsize,const void* const* inputs,void*TRT_CONST_ENQUEUE* outputs, void* workspace,cudaStream_t stream) override;
